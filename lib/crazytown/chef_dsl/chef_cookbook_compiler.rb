...
module Crazytown
  module ChefDSL
    module ChefCookbookCompiler
      def is_crazytown_cookbook?(cookbook_name)
        cookbook_collection[cookbook_name].metadata.dependencies.has_key?('crazytown')
      end
      ...
      def load_lwrp_resource(cookbook_name, filename)
        if is_crazytown_cookbook?(cookbook_name)
          begin
            ...
            resource_class = Crazytown.resource resource_name do
