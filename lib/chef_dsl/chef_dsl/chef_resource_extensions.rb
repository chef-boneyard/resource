...
require 'chef_dsl/chef_dsl/chef_resource_log'
require 'chef_dsl/chef_dsl/chef_recipe_dsl_extensions'
require 'chef_dsl/types'

module ChefDSL
  module ChefDSL
    module ChefResourceExtensions
      include Chef::DSL::Recipe
      include ChefDSL::ChefDSL::ChefRecipeDSLExtensions
      ...
      #
      # Subtle difference from ChefDSL::Resource::StructResource.reopen_resource:
      ...
      #
      def load_from(*args)
        raise NotImplementedError, "load_from is not implemented on ChefDSL resources."
      end
