...
require 'chef_dsl/simple_struct'
...
module ChefDSL
  module Type
    ...
    def coerce_to_user(parent, value)
      if value.is_a?(ChefDSL::LazyProc)
    ...
    def validate(parent, value)
      ...
      if value && !must_be_kind_of.empty? && !must_be_kind_of.any? { |type| value.is_a?(type) }
        raise ValidationError.new("must be a #{ChefDSL.english_list(*must_be_kind_of, conjunction: 'or')}", value)
      end
    ...
    #
    # @example Symbols
    #   type(:boolean) #=> ChefDSL::Types::Boolean
    #   type(:rational) #=> ChefDSL::Types::NumericType
    #   type(:my_resource) #=> MyResource
    # @example Primitive types
    #   type(Fixnum) #=> ChefDSL::Types::IntegerType
    #   type(Rational) #=> ChefDSL::Types::NumericType
    #   type(Hash) #=> nil
  ...
  require 'chef_dsl/types/boolean'
  require 'chef_dsl/types/interval'
  require 'chef_dsl/types/byte_size'
  require 'chef_dsl/types/path'

  require 'chef_dsl/types/integer_type'
  require 'chef_dsl/types/float_type'
  require 'chef_dsl/types/uri_type'
  require 'chef_dsl/types/date_time_type'
  require 'chef_dsl/types/date_type'
  require 'chef_dsl/types/symbol_type'
  require 'chef_dsl/types/string_type'
end
