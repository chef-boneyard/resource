...
By pulling `load_current_resource` into the resource and setting the default value of the resource's attributes to their current value, Crazytown has in effect created both a write *and* a read API.  You don't even have to modify anything.
